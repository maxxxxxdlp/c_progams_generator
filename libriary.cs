	class api {
		public static class helper
		{
			...
			public static string generateRandomWeekDate(){
				return intToWeekDay(generateRandomNumber(0,7));
			}
			...
			public static string[] objectToString(object b){
				return b.ConvertAll(x => x.ToString()).ToArray();
			}

			public static string dateTimeToWeekDay(DateTime dateValue)
			{
				return dddToWeekDay(dateValue.ToString("ddd"));
			}

			public static string dddToWeekDay(string number)
			{

				IDictionary<string, string> transform = new Dictionary<string, string>();
				transform["Mon"] = "Monday";
				transform["Tue"] = "Tuesday";
				transform["Wed"] = "Wednesday";
				transform["Thu"] = "Thursday";
				transform["Fri"] = "Friday";
				transform["Sat"] = "Saturday";
				transform["Sun"] = "Sunday";

				return transform[number];
			}

			public static string intToWeekDay(int number)
			{
				if (number < 0 || number > 6)
					return "";

				IDictionary<int, string> transform = new Dictionary<int, string>();
				transform[0] = "Monday";
				transform[1] = "Tuesday";
			...
			public static TimeSpan differenceBetweenData(DateTime d1, DateTime d2)
			{
				return d1 - d2;
			}
		...
		public class worker : person {
			...
			public int dateIn = helper.generateRandomNumber(1000000000, helper.unixExample);
